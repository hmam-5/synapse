  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500 ease-out">
      ...
      <Link
        ...
        className="w-full flex items-center justify-center py-3 px-4 bg-card border border-border font-medium rounded-lg hover:bg-accent transition-all shadow-sm text-sm"
      >
